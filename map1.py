...
fg.add_child(folium.Marker(location=[28.2, -95.1],popup="Hi I am a Marker", icon=folium.Icon(color='green')))
fg.add_child(folium.Marker(location=[27.2, -95.1],popup="Hi I am a Marker", icon=folium.Icon(color='green')))
map.add_child(fg)
